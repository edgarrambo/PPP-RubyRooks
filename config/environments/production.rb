...
Rails.application.configure do
  config.action_mailer.default_url_options = { host: 'peninsula-pirate-pawns.herokuapp.com/' }
  ...
  # config.active_job.queue_name_prefix = "peninsula-pirate-pawns_#{Rails.env}"
